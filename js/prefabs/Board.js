...
/*
check if two bloxks are adjacent
*/
...
Match3.Board.prototype.clearChains = function(){
    //gets all the blocks taht need to be cleared
...
/*
Drop a block in the main grid from a position to another. the source is set to 0
*/
